...
module.exports.routes = {
 ...
 /* '/login' : {
  ...
  'get /user/:contactId/contact': {
    controller    : 'contact',
    action        : 'findOneUserContact'
  },
  // request
  'post /user/:contactId/contact-request': {
    controller    : 'contact',
    action        : 'requestContact'
  },
  // accept
  'post /user/:contactId/contact-accept': {
    controller    : 'contact',
    action        : 'acceptContact'
  },
  // ignore
  'post /user/:contactId/contact-ignore': {
    controller    : 'contact',
    action        : 'ignoreContact'
  },
  // delete contact relation
 /* 'delete /user/:contactId/contact/': {
    controller    : 'contact',
